...
import com.mychat.chatapp.service.CustomUserDetailsService;
...
public class SecurityConfig {
    ...
    /**
     * (Unused) Method returning BCryptPasswordEncoder instance.
     * Could be removed to avoid duplication since passwordEncoder() exists.
